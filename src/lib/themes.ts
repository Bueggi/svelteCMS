...
export const themes: Theme[] = [
    ...
    },
    {
        id: 'lumina',
        name: 'Lumina',
        description: 'Dark Studio — tiefes Schwarz, Amber-Gold-Akzent, clean & modern.',
        preview: { bg: '0 0% 5%', primary: '38 92% 50%', secondary: '0 0% 12%', accent: '38 92% 50%' },
        vars: {
            radius: '0.75rem',
            background: '0 0% 5%',
            foreground: '0 0% 95%',
        ...
        colors: { primary: '38 92% 50%', secondary: '0 0% 12%', accent: '38 92% 50%', background: '0 0% 5%', foreground: '0 0% 95%' },
    },
];
