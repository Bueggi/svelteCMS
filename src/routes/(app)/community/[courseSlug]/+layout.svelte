...
<div class="flex h-[calc(100vh-4rem)]"> <!-- Adjust height based on header -->
    <!-- Community Sidebar -->
    <aside class="w-64 border-r bg-muted/10 hidden md:flex flex-col">
        <div class="p-4 border-b">
            ...
            <p class="text-xs text-muted-foreground uppercase tracking-widest mt-1">Community</p>
        </div>
                     ...
                     <Dialog>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription>Add a new discussion topic.</DialogDescription>
                            </DialogHeader>
                            <form action="/community/{course.slug}?/createCategory" method="POST" class="space-y-4">
                                <div class="space-y-2">
                                    <Label for="name">Channel Name</Label>
                                    <Input id="name" name="name" placeholder="e.g. Announcements" required />
                                </div>
                                <DialogFooter>
